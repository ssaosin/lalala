...
messages = ['owo cash', 'owo h', 'owo daily', 'owo cf 10000', 'owo quest', 'owo zoo', 'owo cookie', 'owo hunt', 'owo lootbox', 'owo roll 100', 'owo cf t', 'owo cf h', 'owo cf h 1000', 'owo pray', 'w inv', 'w lb all']
headers = {
